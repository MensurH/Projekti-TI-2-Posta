...
namespace Projekti_TI_2_Posta.Infrastructure.Migrations
{
    public partial class posta : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostierID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Pagesa = table.Column<int>(type: "int", nullable: false),
                    ERegjistruar = table.Column<bool>(type: "bit", nullable: false),
                    EDerguar = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Porosias", x => x.ID);
                });
